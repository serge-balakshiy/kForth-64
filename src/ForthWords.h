...
//  { "D>=",       OP_DGE,          0 },
    ...
    { "TESTPRIVET", OP_GR_TESTPRIVET, 0 },
    { "KF64PRIVET", OP_KF64PRIVET, 0 },
    { "GPRIVET", OP_GPRIVET, 0 },
    { "GLLSHOW",  OP_GLLSHOW, 0 },
    ...
    { "NEWFRGRAPH", OP_GR_NEWFRGRAPH,  0 },
    { "NEWUGRAPH", OP_GR_NEWUGRAPH,  0 },
    { "UGADDEDGE", OP_GR_ADDEDGE, 0 },
    { "CLEARUGRAPH", OP_GR_CLEARUGRAPH, 0 },
    { "TYPEUGRAPH", OP_GR_TYPEUGRAPH, 0 },
    { "GETNUMVERTICES", OP_GR_GETNUMVERTICES, 0 },
    { "UGSETFRAME", OP_GR_SETFRAME, 0 },
    { "UGSETITER", OP_GR_SETITER, 0 },
    { "UGFORCELAYOUT", OP_GR_FORCELAYOUT, 0 },
    { "UGINITVI", OP_GR_INITVI, 0 },
    { "UGNEXTVI", OP_GR_NEXTVI, 0 },
    { "UGVPOS", OP_GR_VPOS, 0 },
    { "UGWIDTH", OP_GR_WIDTH, 0 },
    { "UGHEIGHT", OP_GR_HEIGHT, 0 },
    { "UGINITEI", OP_GR_INITEI, 0 },
    { "UGNEXTEI", OP_GR_NEXTEI, 0 },
    { "GETNUMEDGES", OP_GR_GETNUMEDGES, 0 },
    { "GETSRCVPOS", OP_GR_GETSRCVPOS, 0 },
    { "GETTRGVPOS", OP_GR_GETTRGVPOS, 0 }
};
